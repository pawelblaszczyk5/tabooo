...
<div
	...
	class="z-20 glass-sm transition-colors ease-linear duration-300 border border-gray-200 border-opacity-40 absolute top-48 left-1/2 transform -translate-x-1/2 p-10 bg-primary rounded-2xl">
